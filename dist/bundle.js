(function () {
    ...
    const [bullet$1, bulletMask] = generateBullet();
    ...
    class Bullet {
      ...
      run(hitables, ctx, time) {
        ...
        const hitBox = [this.x, this.y, bullet$1.width, bullet$1.height, bulletMask];
        ...
        if (this.y + Math.floor(bullet$1.height / 2) < 0) {
          return false;
        }
        this.lastTime = time;
        ctx.drawImage(
          bullet$1,
          this.x - Math.floor(bullet$1.width / 2),
          this.y - Math.floor(bullet$1.height / 2)
        );
        return true;
      }
    }
